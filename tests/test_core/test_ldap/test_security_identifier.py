...
def f_valid_sid_bytearray() -> bytearray:
	...
	return bytearray(b'\x01\x05\x00\x00\x00\x00\x00\x05\x15\x00\x00\x00\x11^\xb3\x83j\x06\x94\x00\x80\xdbi\xaa\x87\x04\x00\x00')
...
def f_object_wrapper(mocker: MockType) -> Any:
	...
	mock_obj.raw_values = [bytearray(b'\x01\x05\x00\x00\x00\x00\x00\x05\x15\x00\x00\x00\x11^\xb3\x83j\x06\x94\x00\x80\xdbi\xaa\x87\x04\x00\x00')]
	return mock_obj
