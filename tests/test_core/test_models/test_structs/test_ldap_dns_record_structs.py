...
@pytest.fixture
def f_dns_record_a():
	record: DNS_RECORD = new_record(RecordTypes.DNS_RECORD_TYPE_A.value, serial=1, ttl=180)
...
def f_dns_record_aaaa():
	record: DNS_RECORD = new_record(RecordTypes.DNS_RECORD_TYPE_AAAA.value, serial=1, ttl=180)
...
def f_dns_record_cname():
	record: DNS_RECORD = new_record(RecordTypes.DNS_RECORD_TYPE_CNAME.value, serial=1, ttl=180)
...
def f_dns_record_txt():
	record: DNS_RECORD = new_record(RecordTypes.DNS_RECORD_TYPE_TXT.value, serial=1, ttl=180)
...
def f_dns_record_soa(f_dns_record_soa_values):
	record: DNS_RECORD = new_record(RecordTypes.DNS_RECORD_TYPE_SOA.value, serial=1, ttl=180)
