...
def test_d_set_search_attrs_raises_type_error(mocker: MockerFixture, bad_value):
	mocker.patch.object(LDAPObject, "__init__", return_value=None)
	m_ldap_object = LDAPObject()
...
def test_d_set_search_attrs(mocker: MockerFixture, search_attrs, expected):
	mocker.patch.object(LDAPObject, "__init__", return_value=None)
	m_ldap_object = LDAPObject()
...
def test_ddr_get__methods(mocker, get_name_args):
...
def test_ddr_fetch_object_returns_none_on_empty_response(
...
def test_ddr_fetch_object_removes_empty_string(
	f_object_attrs_user,
	f_object_entry_user,
	f_connection,
	f_object_args,
...
def test_ddr_fetch_object_marks_builtin(
	object_classes,
	f_object_entry_user,
	f_connection,
	f_object_args,
...
def test_ddr_fetch_object_no_results_returns_none(
...
def test_ddr_fetch_object_handles_sid_conversion(
...
def test_ddr_fetch_object_handles_iterable_attributes(
...
def test_ddr_ldap_attrs_returns_attribute_keys(
	f_object_args, f_object_entry_user, f_connection
):
	# Setup
	object_args = f_object_args()
...
def test_ddr_ldap_attrs_returns_empty_list_when_no_attributes(
	f_object_args, f_connection
):
	# Setup
	object_args = f_object_args()
