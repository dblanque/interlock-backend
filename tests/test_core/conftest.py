...
class ConnectorFactory(Protocol):
    def __call__(self, patch_path: str, use_spec = False, mock_enter: MockType = None, mock_exit: MockType = None) -> LDAPConnector | MockType: ...

@pytest.fixture
def g_ldap_connector(mocker: MockerFixture) -> ConnectorFactory:
	def maker(patch_path: str, use_spec = False, mock_enter: MockType = None, mock_exit: MockType = None):
