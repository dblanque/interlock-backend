...
LEAP_YEAR = datetime(2024, 2, 29, 12, 0, 0, tzinfo=timezone.utc)  # Valid leap date
WINDOWS_EPOCH = datetime(1601, 1, 1, tzinfo=timezone.utc)
KNOWN_VALUES = [
    (WINDOWS_EPOCH, 0),
    (EPOCH_UTC, 116444736000000000),
    (datetime(2023, 1, 1, tzinfo=timezone.utc), 133170048000000000),  # CORRECTED
    (datetime(1999, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc), 125911583999999990)  # CORRECTED
]
