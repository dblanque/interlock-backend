# Generated by Django 4.2.4 on 2025-03-13 01:19
	...
	operations = [
		migrations.CreateModel(
			...
			fields=[
				...
				(
					"username",
					models.CharField(max_length=128, unique=True, verbose_name="username"),
				),
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					"affectedObject",
					models.JSONField(blank=True, null=True, verbose_name="affectedObject"),
				),
				(
					"extraMessage",
					models.CharField(
