# Generated by Django 3.2 on 2022-08-02 20:11
...
class Migration(migrations.Migration):
    ...
    replaces = [('core', '0001_initial'), ('core', '0002_auto_20220731_0239'), ('core', '0003_remove_log_rotated'), ('core', '0004_log_willrotate'), ('core', '0005_auto_20220731_0315'), ('core', '0006_alter_log_objectclass'), ('core', '0007_alter_log_id'), ('core', '0008_alter_log_affectedobject'), ('core', '0009_remove_log_rotated_at')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objectClass', models.CharField(choices=[('USER', 'User'), ('GROUP', 'Group'), ('OU', 'Organizational Unit'), ('DOM', 'Domain'), ('GPO', 'Group Policy Object'), ('LDAP', 'LDAP Object'), ('CONN', 'Connection'), ('SET', 'Setting')], max_length=256, verbose_name='objectClass')),
                ...
                ('logged_at', models.DateTimeField(auto_now_add=True, default=django.utils.timezone.now, verbose_name='logged at')),
